...
private:
    ...
    //Queston4: Robot::moveXYT method caanot be available for external use in practice so move it to provate class
...
public:
    ...
    void initWheels(double r,double b,double Omegamax);
